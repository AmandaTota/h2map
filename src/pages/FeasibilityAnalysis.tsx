                              ...
                              <div className="grid md:grid-cols-2 gap-4">
                                <Card className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
                                  <p className="text-sm text-slate-700 mb-2">
                                    ...
                                    {energyCalc1Year.solarIrradiance.toFixed(0)}{" "}
                                    W/m²
                                  </p>
                                  <p className="text-sm text-slate-700 mb-2">
                                  ...
                                  <p className="text-xs text-slate-600 mt-2 p-2 bg-white/50 rounded">
                                    <strong>Fórmula:</strong> P<sub>solar</sub>{" "}
                                    = G × A × η
                                  </p>
                                ...
                                <Card className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200">
                                  ...
                                  <p className="text-xs text-slate-600 mt-2 p-2 bg-white/50 rounded">
                                    <strong>Fórmula:</strong> P<sub>eólica</sub>{" "}
                                    = ½ × ρ × A × v³ × η
                                  </p>
                            ...
                            <div>
                              ...
                              <div className="grid md:grid-cols-2 gap-4">
                                <Card className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
                                  ...
                                  <p className="text-2xl font-bold text-amber-600 mt-3">
                                    {energyCalc3Years.solarPower.toFixed(1)} kW
                                  </p>
                                  <p className="text-xs text-slate-600">
                                    Potência Solar Gerada
                                  </p>
                                ...
                                <Card className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200">
                                  <p className="text-sm text-slate-700 mb-2">
                                    💨 <strong>Velocidade do Vento:</strong>{" "}
                                    {energyCalc3Years.windSpeed.toFixed(1)} m/s
                                  </p>
                                  <p className="text-sm text-slate-700 mb-2">
                                    📐 <strong>Área Varrida:</strong>{" "}
                            ...
                            <div>
                              ...
                              <div className="grid md:grid-cols-2 gap-4">
                                <Card className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
                                  ...
                                  <p className="text-2xl font-bold text-amber-600 mt-3">
                                    {energyCalc5Years.solarPower.toFixed(1)} kW
                                  </p>
                                  <p className="text-xs text-slate-600">
                                    Potência Solar Gerada
                                  </p>
                                ...
                                <Card className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200">
                                  <p className="text-sm text-slate-700 mb-2">
                                    💨 <strong>Velocidade do Vento:</strong>{" "}
                                    {energyCalc5Years.windSpeed.toFixed(1)} m/s
                                  </p>
                                  <p className="text-sm text-slate-700 mb-2">
                                    📐 <strong>Área Varrida:</strong>{" "}
                      ...
                      <AccordionContent className="px-6 pb-6">
                        ...
                        <Card className="mt-6 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
                          ...
                          <ul className="text-sm text-slate-700 space-y-1 ml-4 list-disc">
                            ...
                            <li>
                              <strong>LCOH:</strong> Custo nivelado do H₂ (CAPEX
                              + OPEX / Produção)
                            </li>
                            <li>
                            ...
                            <li>
                              <strong>Operação:</strong> 20-100% quando energia
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                              <Card className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200">
                                ...
                                <p className="text-3xl font-bold text-slate-900">
                                  R$ {simulationResults.oneYear.lcoh.toFixed(2)}
                                </p>
                              ...
                              <Card className="p-4 bg-gradient-to-br from-emerald-50 to-teal-50 border-emerald-200">
                                ...
                                <Badge className="mt-2 bg-emerald-100 text-emerald-800 text-xs">
                                  {simulationResults.oneYear.capacityFactor > 40
                                    ? "✓ Excelente"
                              ...
                              <Card className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
                                ...
                                <p className="text-3xl font-bold text-slate-900">
                                  R${" "}
                                  {(
                                    simulationResults.oneYear.h2Production * 25
                                  ...
                                  <p className="text-xl font-bold text-green-600">
                                    {(
                                      ...
                                      (simulationResults.fiveYears!
                                        .h2Production *
                                        25 -
                                        simulationResults.fiveYears!.opexAnnual)
                                    ).toFixed(1)}{" "}
                                    anos
                                  </p>
                                </div>
                            ...
                            <Card className="p-4 h-full hover:shadow-lg transition-shadow">
                              <div className="flex items-start space-x-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  <Badge
                                    variant="outline"
                                    className={getPriorityColor(factor.status)}
                                  >
                                    {factor.value}
                                  </Badge>
                                  <p className="text-xs text-slate-600 mt-2">
                        ...
                        >
                          ...
                          <TabsContent value="3">
                            <div className="space-y-4">
                              ...
                              <div
                                className={`flex items-start space-x-3 p-4 rounded-lg border ${
                                  simulationResults.threeYears!.capacityFactor >
                                  30
                                    ? "bg-emerald-50 border-emerald-200"
                                    : "bg-amber-50 border-amber-200"
                                }`}
                              ...
                              <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-slate-700">
                                    ...
                                    toneladas de H₂ verde no cenário de 300 kW.
                                    Este eletrolisador de média capacidade é
                                    adequado para projetos industriais de
                                    pequeno porte.
                                  </p>
                                  <p className="text-xs text-slate-600 mt-2">
                          ...
                          <TabsContent value="5">
                            <div className="space-y-4">
                              ...
                              <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-slate-700">
                                    ...
                                    toneladas de H₂ verde no cenário de 500 kW.
                                    Este eletrolisador de grande capacidade é
                                    ideal para operações comerciais de escala
                                    industrial.
                                  </p>
                                  <p className="text-xs text-slate-600 mt-2">
                              ...
                              <div
                                className={`flex items-start space-x-3 p-4 rounded-lg border ${
                                  simulationResults.fiveYears!.capexAnnualized /
                                    0.117 /
                                    (simulationResults.fiveYears!.h2Production *
                                      25 -
                                      simulationResults.fiveYears!.opexAnnual) <
                      ...
                      <AccordionContent className="px-6 pb-6">
                        <div className="space-y-3">
                            ...
                            >
                              ...
                              <div className="flex-1 flex items-center justify-between">
                                <p className="text-slate-700">
                                  ...
                                  %). Considere reduzir tamanho do eletrolisador
                                  ou aumentar capacidade de geração renovável.
                                </p>
                                <Badge
                                  variant="outline"
                            ...
                            >
                              ...
                              <div className="flex-1 flex items-center justify-between">
                                <p className="text-slate-700">
                                  ...
                                  {(
                                    simulationResults.oneYear.curtailment / 1000
                                  ).toFixed(1)}{" "}
                          ...
                          >
                            ...
                            <div className="flex-1 flex items-center justify-between">
                              <p className="text-slate-700">
                                <strong>Contratos de Offtake:</strong> Negociar
                                acordos de compra de longo prazo (10-15 anos)
                                com potenciais clientes industriais para
                                garantir receita.
                              </p>
                              <Badge
                                variant="outline"
