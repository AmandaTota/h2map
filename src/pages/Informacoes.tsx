...
export default function Informacoes() {
  ...
  const toggleSection = (section: keyof typeof expandedSections) => {
    // On mobile, open a dialog instead of expanding inline
    if (isMobile) {
      setDialogOpen((prev) => ({ ...prev, [section]: !prev[section] }));
      return;
    }
  ...
  useEffect(() => {
    // Detect small screens based on tailwind md breakpoint (768px)
            ...
            <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
              <div>
                <h2 className="text-2xl font-bold text-slate-900 text-center mb-2">
                  Calculadora: Deslocamento ao trabalho
                </h2>
            ...
            <div className="bg-gradient-to-r from-amber-100 via-yellow-100 to-orange-100 rounded-xl shadow-lg border border-amber-200 p-6 mb-6">
              <div className="flex items-start gap-4 ">
                ...
                <div className="flex-1 relative">
                  ...
                  {!isMobile && expandedSections.cleanEnergy && (
                  ...
                  {/* Mobile dialog */}
                  <Dialog
                    open={dialogOpen.cleanEnergy}
                    onOpenChange={(open) =>
                      setDialogOpen((prev) => ({ ...prev, cleanEnergy: open }))
                    }
                  >
                    <DialogContent className="max-w-md p-4">
                      <DialogTitle>O que é energia limpa?</DialogTitle>
                      <DialogDescription>
                        Energia limpa e exemplos — toque para fechar.
                      </DialogDescription>

                      <div className="text-slate-700 leading-relaxed space-y-4 mt-2">
                        <p>
                          Energia limpa é toda forma de geração de energia que
                          não emite poluentes significativos nem gases de efeito
                          estufa durante sua produção ou uso. Ela busca reduzir
                          impactos ambientais e contribuir para a
                          sustentabilidade.
                        </p>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="bg-white/60 rounded-lg p-3">
                              ...
                              <p className="text-sm text-slate-600">
                                Menor impacto na saúde humana e nos
                                ecossistemas.
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="bg-gradient-to-r from-emerald-100 via-teal-100 to-cyan-100 rounded-xl shadow-lg border border-emerald-200 p-6 mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 relative">
                        ...
                        {!isMobile && expandedSections.greenHydrogen && (
                          <div className="text-slate-700 leading-relaxed space-y-4">
                            <p>
                              Hidrogênio verde é um tipo de hidrogênio produzido
                              de forma sustentável, sem emissão significativa de
                              gases de efeito estufa. Ele é obtido por meio da
                              eletrólise da água, um processo que separa a
                              molécula de H₂O em hidrogênio (H₂) e oxigênio (O₂)
                              usando eletricidade. Para que seja considerado
                              "verde", essa eletricidade precisa vir de fontes
                              renováveis, como energia solar, eólica ou
                              hidrelétrica.
                            </p>
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="bg-white/60 rounded-lg p-3">
                                  ...
                                  <p className="text-sm text-slate-600">
                                    Diferente do hidrogênio cinza (produzido a
                                    partir de gás natural), o verde não gera
                                    CO₂.
                                  </p>
                                </div>
                                <div className="bg-white/60 rounded-lg p-3">
                                  ...
                                  <p className="text-sm text-slate-600">
                                    ...
                                    indústrias, transporte pesado, geração de
                                    energia e até para armazenar energia
                                    renovável.
                                  </p>
                                </div>
                                <div className="bg-white/60 rounded-lg p-3">
                                  ...
                                  <p className="text-sm text-slate-600">
                                    É uma peça-chave para reduzir emissões em
                                    setores difíceis de eletrificar.
                                  </p>
                                </div>
                              </div>
                            </div>
                        ...
                        {/* Mobile dialog for green hydrogen */}
                        <Dialog
                          open={dialogOpen.greenHydrogen}
                          onOpenChange={(open) =>
                            setDialogOpen((prev) => ({
                              ...prev,
                              greenHydrogen: open,
                        ...
                        >
                          <DialogContent>
                            <DialogTitle>O que é hidrogênio verde?</DialogTitle>
                            <DialogDescription>
                              Informações sobre hidrogênio verde — toque para
                              fechar.
                            </DialogDescription>

                            <div className="text-slate-700 leading-relaxed space-y-4 mt-2">
                              <p>
                                Hidrogênio verde é um tipo de hidrogênio
                                produzido de forma sustentável, sem emissão
                                significativa de gases de efeito estufa. Ele é
                                obtido por meio da eletrólise da água, um
                                processo que separa a molécula de H₂O em
                                hidrogênio (H₂) e oxigênio (O₂) usando
                                eletricidade. Para que seja considerado "verde",
                                essa eletricidade precisa vir de fontes
                                renováveis, como energia solar, eólica ou
                                hidrelétrica.
                              </p>
