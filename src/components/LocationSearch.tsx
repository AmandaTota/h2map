...
const LocationSearch = ({ onLocationSelect, initialLocation }: LocationSearchProps) => {
  ...
  const brazilianLocations: Location[] = [
    ...
    { lat: -23.3045, lng: -47.4559, name: 'Sorocaba, SP' },
    { lat: -22.7356, lng: -47.6490, name: 'Americana, SP' },
    { lat: -23.4962, lng: -47.4628, name: 'Itu, SP' },
    { lat: -22.5758, lng: -48.6317, name: 'Botucatu, SP' },
    { lat: -21.7631, lng: -48.1825, name: 'Bauru, SP' },
    ...
    { lat: -20.7722, lng: -51.6784, name: 'Araçatuba, SP' },
    { lat: -21.7872, lng: -48.1757, name: 'Bauru, SP' },
    ...
    { lat: -9.6658, lng: -35.7350, name: 'Jequié, BA' },
